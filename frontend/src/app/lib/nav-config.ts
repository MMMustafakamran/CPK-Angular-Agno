 ...
 * exactly once.
 *
 * Groups mirror the sidebar at https://docs.copilotkit.ai/angular/agno as of
 ...
 */
export const DOCS_ROOT = 'https://docs.copilotkit.ai/angular/agno';
...
export const NAV: NavGroup[] = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        hasDemo: true,
        title: 'Quickstart',
        docPath: '/angular/agno/quickstart',
        summary:
          'The smallest end-to-end path: an AgnoAgent in Copilot Runtime, provideCopilotKit, and one copilot-chat.',
        status: 'working',
      },
    ],
  },
    ...
    routes: [
      {
        ...
        docPath: '/angular/agno/guides/chat-ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/agno/guides/a2ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/agno/guides/voice-multimodal',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/agno/guides/human-in-the-loop',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/agno/guides/shared-state',
        summary:
