          ...
          <div class="space-y-0.5">
            ...
            <div class="pl-4">
              <div 
                ...
                [class.bg-[#37373d]]="currentFile() === '../backend/main.py' || currentFile() === 'backend/main.py'"
                [class.text-white]="currentFile() === '../backend/main.py' || currentFile() === 'backend/main.py'"
                (click)="selectFile('../backend/main.py', 35)"
              >
            ...
            <div class="pl-4 space-y-0.5">
              ...
              <div 
                ...
                (click)="selectFile('src/app/app.config.ts', 45)"
              >
                <span class="text-[#3178c6]">TS</span>
              ...
              <div class="pl-3 space-y-0.5">
                <div 
                  class="flex items-center gap-1.5 py-0.5 px-2 rounded cursor-pointer"
                  [class.bg-[#37373d]]="currentFile().includes('quickstart')"
                  [class.text-white]="currentFile().includes('quickstart')"
                ...
                <div 
                  class="flex items-center gap-1.5 py-0.5 px-2 rounded cursor-pointer"
                  [class.bg-[#37373d]]="currentFile().includes('chat-ui')"
                  [class.text-white]="currentFile().includes('chat-ui')"
                  (click)="selectFile('src/app/features/chat-ui/chat-ui-demo.component.ts', 18)"
                >
                  <span class="text-[#3178c6]">TS</span>
                  <span>chat-ui.ts</span>
                </div>
                <div 
                  class="flex items-center gap-1.5 py-0.5 px-2 rounded cursor-pointer"
                  [class.bg-[#37373d]]="currentFile().includes('hitl')"
                  [class.text-white]="currentFile().includes('hitl')"
                  (click)="selectFile('src/app/features/hitl/hitl-chat.component.ts', 20)"
                >
                  <span class="text-[#3178c6]">TS</span>
                  <span>hitl-chat.ts</span>
                </div>
                <div 
                  class="flex items-center gap-1.5 py-0.5 px-2 rounded cursor-pointer"
                  [class.bg-[#37373d]]="currentFile().includes('shared-state')"
                  [class.text-white]="currentFile().includes('shared-state')"
                  (click)="selectFile('src/app/features/shared-state/shared-state-chat.component.ts', 20)"
                >
                  <span class="text-[#3178c6]">TS</span>
                  <span>shared-state.ts</span>
                </div>
              </div>
            </div>
          </div>
