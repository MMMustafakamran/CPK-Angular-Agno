    ...
    <div class="space-y-6">
      ...
      <ui-panel heading="The interrupt controller">
        <p class="mb-3 text-sm text-slate-700">
          ...
          <code>on_interrupt</code> custom event). The Agno agent in this repo
          does not emit one <b>Agno does not support Interrupts</b>, so this half stays idle. The controller clears
